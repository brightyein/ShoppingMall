	...
	<div class="wrap">
			...
			<div class="mail_wrap">
				...
				<div class="mail_check_wrap">
					...
					<span class="final_mailnum_ck">이메일 인증을 완료해주세요.</span>
...
<script>
	...
	/* 아이디 중복검사 */
	$('.id_input').on("propertychange chage keyup paste input", function(){
	...
	/* 이메일 전송 버튼을 눌렀을 때, 이메일 유효성 검사 진행 */
	$(".mail_check_button").click(function(){
